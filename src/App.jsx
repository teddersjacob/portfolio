...
const AI_PROJECTS = [
  {
    ...
    accent: "#4f8ef7",
    Icon: Database,
    logo: "/teddersjacob/logos/logo_savage.png",
    logoSide: "right",
    car: {
  ...
  },
  {
    ...
    accent: "#4f8ef7",
    Icon: Bot,
    logo: "/teddersjacob/logos/logo_church.png",
    logoSide: "left",
    car: {
  ...
  },
  {
    ...
    accent: "#a78bfa",
    Icon: Map,
    logo: "/teddersjacob/logos/logo_enhancedai.png",
    logoSide: "right",
    car: {
...
const OTHER_PROJECTS = [
  {
    ...
    accent: "#f59e0b",
    Icon: CreditCard,
    logo: "/teddersjacob/logos/logo_roulette.png",
    logoSide: "left",
    car: {
  ...
  },
  {
    ...
    accent: "#60a5fa",
    Icon: BarChart2,
    logo: "/teddersjacob/logos/logo_qualtrics.png",
    logoSide: "right",
    car: {
        ...
        <FadeIn>
          <div style={{ position: "relative" }}>
            <div style={{ width: "220px", height: "260px", borderRadius: "28px", overflow: "hidden", boxShadow: "0 20px 60px rgba(0,0,0,0.12)" }}>
              <img src="/teddersjacob/headshot.jpg" alt="Jacob Tedders" style={{ width: "100%", height: "100%", objectFit: "cover", objectPosition: "center top" }} />
            </div>
